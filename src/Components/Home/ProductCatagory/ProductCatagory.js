...
const ProductCatagory = ({ catagory }) => {
    const { _id, catagoryImg, catagoryName, info } = catagory;

    return (
        <div className="max-w-sm rounded-md shadow-md dark:bg-teal-700 dark:text-gray-100">
            <PhotoProvider>
                <PhotoView src={catagory.categoryImg} >
                    <img src={catagoryImg} alt="" className="object-cover object-center w-full rounded-t-md h-40 dark:bg-gray-500" />
                </PhotoView>
            </PhotoProvider>
